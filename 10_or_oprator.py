...
elif donor=='a-' and (receiver=='o+' or  receiver=='a-'): 
    print(f"donor {donor} can give blood to receiver {receiver}")

elif donor=='b+' and (receiver=='o+' or receiver=='o-' or receiver=='b+' or receiver=='b-'): 
    print(f"donor {donor} can give blood to receiver {receiver}")

elif donor=='b-' and (receiver=='o-' or  receiver=='b-'): 
    print(f"donor {donor} can give blood to receiver {receiver}")
  
elif donor=='ab+' and (receiver=='o+' or receiver=='o-' or receiver=='a+' or receiver=='a-'or receiver=='b+' or receiver=='b-' or receiver=='ab+' or receiver=='ab-' ): 
    print(f"donor {donor} can give blood to receiver {receiver}")

elif donor=='ab-' and (receiver=='o-' or  receiver=='a-'or  receiver=='b-' or receiver=='ab-' ): 
    print(f"donor {donor} can give blood to receiver {receiver}")
    
else:
   print(f"donor {donor} can not give blood to receiver {receiver}")
